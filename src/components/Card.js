...

            {
                showData === true ? (
                    ...
                    <div className="container">
                        <div className="card mb-3 mx-auto text-light back">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    ...
                                    <img src="https://images.pexels.com/photos/1722183/pexels-photo-1722183.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="img-fluid rounded-start img" alt="..."/>
                                </div>
